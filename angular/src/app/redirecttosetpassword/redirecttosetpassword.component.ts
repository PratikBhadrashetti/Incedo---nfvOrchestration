...
@Component({    
    templateUrl: './redirecttosetpassword.component.html',
    styleUrls:['./redirecttosetpassword.component.css']
})

export class RedirecttosetpasswordComponent implements OnInit {
    model: any = {};
    loading = false;
    passworderror=false;
    ...
    setpassword(){
        if(this.model.password!==this.model.confirmpassword){
        	...
        	this.authenticationService.setNewPassword(body, this.token).subscribe(
			(res) =>{
